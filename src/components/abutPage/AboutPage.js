        ...
        <div className="Background">
            <div className="AboutPage">
                <div class="AboutParagraph">
                    <span class="BoldText">This website shows information about earthquakes located and
                ...
                <div class="AboutParagraph">
                    <span class="BoldText">It is important to note that the USGS does not locate all
                ...
                <div class="AboutParagraph BoldText">
                    Check with your regional network for more comprehensive earthquakes information on
                    your region.
                </div>
                <div class="AboutParagraph">
                    <span class="BoldText">If you delete your browser data your pinned earthquakes will
                        be deleted too.</span> Pinned earthquakes are saved on your device local storage
